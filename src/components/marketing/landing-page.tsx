...
const plans = [
  {
    ...
    price: "£29",
    period: "/ month",
    description: "For a single gym getting members, classes, and the door online.",
    features: [
      "Up to 150 active members",
      "QR code entry and door scanning",
      "Basic schedule and check-in",
      "Manual payments and direct links",
  ...
  },
  {
    ...
    price: "£59",
    period: "/ month",
    description: "For gyms that need unlimited members, waitlists, and direct debits.",
    features: [
      "Unlimited members",
      "QR code entry and hardware integration",
      "Advanced class management and waitlists",
      "Automated direct debits and PaySynk",
      "Priority support and onboarding setup",
    ],
    cta: "Start with Pro",
    href: "/login",
    popular: true,
